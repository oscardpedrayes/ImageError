...
public:
	...
	const double compare_ECM(const Image &img) const;
	const double compare_PSNR(const Image &img) const; // Good images 30-50db
	const double compare_SSIM(const Image &img) const;
